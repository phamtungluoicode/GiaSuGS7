...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        'name', 'email', 'password', 'role', 'gender', 'date_of_birth',
        'avatar', 'phone', 'address', 'coin', 'school_id', 'Citizen_card',
        'education_level', 'class_id', 'subject', 'salary_id', 'exp',
        'current_role', 'description', 'time_tutor_id', 'status',
        'DistrictID', 'latitude', 'longitude', 'google_id', 'Certificate',
        'assign_user', 'Certificate_public', 'code', 'time_accept',
        'approved_by',
    ];
