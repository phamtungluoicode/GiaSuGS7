            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            @if($connect->confirm_user != 1 && $connect->confirm_user != 2)
                            <div class="flex items-center gap-2">
                                <form action="{{ route('user.connects.confirm', $connect->id) }}" method="POST" class="inline">
                                    @csrf
                                    <button type="submit"
                                        ...
                                        onclick="return confirm('Xác nhận kết nối với gia sư này?')">
                                        Đã kết nối
                                    </button>
                                </form>
                                <form action="{{ route('user.connects.deny', $connect->id) }}" method="POST" class="inline" data-confirm="Bạn có chắc chắn?">
                                    @csrf
                                    <button type="submit"
