...
@section('title', 'Sửa ca học - Admin')
@section('header', 'Cập nhật ca học')
...
<div class="max-w-lg mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        <form method="POST" action="{{ route('admin.timeslots.update', $timeSlot->id) }}">
            ...
            <div>
                <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Ca học</label>
                <input type="text" name="name" id="name" value="{{ old('name', $timeSlot->name) }}"
            ...
            <div class="mt-6 flex items-center gap-4">
                ...
                <a href="{{ route('admin.timeslots.index') }}" class="text-gray-600 hover:text-gray-800 transition">Hủy</a>
            </div>
        </form>
    </div>
</div>
