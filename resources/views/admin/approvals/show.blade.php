...
@section('title', 'Chi tiết phê duyệt - Admin')
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="mt-6 flex items-center gap-4 border-t border-gray-200 pt-6">
            <form action="{{ route('admin.approvals.approve', $teacher->id) }}" method="POST">
                @csrf
            ...
            <form action="{{ route('admin.approvals.reject', $teacher->id) }}" method="POST" data-confirm="Bạn có chắc chắn muốn từ chối?" onsubmit="return confirm('Bạn có chắc chắn muốn từ chối gia sư này?')">
                @csrf
            ...
            <a href="{{ route('admin.approvals.index') }}" class="inline-flex items-center bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
