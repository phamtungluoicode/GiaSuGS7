...
@section('title', 'Đăng nhập - GS7')

@section('content')
<div class="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-white/20">
    <h2 class="text-2xl font-bold font-heading text-stone-800 text-center mb-6">Đăng nhập</h2>
    ...
    <div class="flex items-center my-6">
        ...
        <span class="px-4 text-sm text-stone-400">hoặc</span>
        <div class="flex-1 border-t border-stone-200"></div>
    </div>
    ...
    <a
        href="/auth/google"
        class="w-full flex items-center justify-center gap-3 bg-white border border-stone-200 hover:bg-stone-50 hover:border-stone-300 text-stone-700 font-medium py-2.5 px-4 rounded-xl transition-all duration-200 text-sm shadow-sm"
    >
    ...
    <div class="mt-6 text-center space-y-2">
        <p class="text-sm text-stone-600">
            Chưa có tài khoản?
            <a href="{{ route('register.user') }}" class="text-primary-600 hover:text-primary-700 font-medium hover:underline transition-colors">
                Đăng ký học viên
            </a>
        </p>
        <p class="text-sm text-stone-600">
            Bạn là gia sư?
            <a href="{{ route('register.teacher') }}" class="text-primary-600 hover:text-primary-700 font-medium hover:underline transition-colors">
                Đăng ký gia sư
            </a>
        </p>
    </div>
